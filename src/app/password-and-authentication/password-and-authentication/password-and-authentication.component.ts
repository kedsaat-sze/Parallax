...
export class PasswordAndAuthenticationComponent {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.audio.src = `https://storage.googleapis.com/sbox-parallax/password_and_authentication/audio/password_and_authentication${localStorage.getItem("name") ? "-" + localStorage.getItem("name") : ""}.mp3`;
    ...
    this.http.get<any>('./assets/json/password_and_authentication.json').subscribe((data) => {
