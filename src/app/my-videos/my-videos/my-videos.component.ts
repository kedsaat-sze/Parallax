...
export class MyVideosComponent implements OnInit {
  ...
  onDelete(element: Video) {
    this.sharedDataService.deleteAnimationData(`sharedvideos/${this.email}'s "${element.name}"`, `gs://sbox-parallax.app/users/${this.email}/vid_${element.name}/${element.name}.json`, `gs://sbox-parallax/users/${this.email}/vid_${element.name}/${element.audio?.split("/").pop()}`);
